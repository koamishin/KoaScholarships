...
export function FAQSection() {
    const faqs = [
        {
            question: `Who is eligible to apply for ${brandName}?`,
        ...
        },
        {
            ...
            answer: `College scholarship recipients must complete 6 days of community service, while high school recipients must complete 4 days. Service opportunities are coordinated through the ${brandName} program and can include various community projects.`,
        },
        {
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-muted-foreground mx-auto max-w-2xl">
                        Find answers to common questions about the {brandName} program and application process.
                    </p>
                </div>
